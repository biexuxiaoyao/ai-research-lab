...
- **06 测试与QA** — [覆盖率信号贬值](../06-测试与QA/README.md)与本章"行为覆盖率"（17.2.3）形成信号体系的完整迁移路径：从代码覆盖率 → 突变测试 → Agent 行为覆盖率
...
- **14 Agent-Harness** — [Harness 可观测性](../14-Agent-Harness与运行时/147-Harness可观测性.md)是本章三支柱的 Harness 层实现
